...
For my project, I decided to choose the tool Vue JS. Vue JS is a friendly and simple JavaScript framework to help build interfaces. The reason why I chose Vue JS was that I was between React JS and Vue JS to help me make my calculus memorization game, but the way you had to download React JS locally was difficult, due to school device restrictions. However, I found out that Vue JS was simpler, and I was able to locally use Vue JS with no problems, so I wouldn't have had to be stuck using a CDN. I also found Vue JS to be more friendly and easier to comprehend than Vue JS. With Vue JS, I plan to use it to help me make a userinteractive calculus concept memorization game. My goal is to help AP calculus students and myself retain important key concepts for the AP exam in May.

To experiment with Vue JS, I used the [official Vue documentation](https://vuejs.org/guide/quick-start.html) and I used [Scrimba](https://scrimba.com/learn-vue-c0jrrpaasr). My tinkering for Vue JS was done [here](../tool/vue-js-testing). When I was first testing out React JS to have a feel of it, I tinkered [here](../tool/react-js-attempt) and used tutorials on [YouTube](https://www.youtube.com/watch?v=5Hdw6RI2Fwk).

I tinkered with Vue JS by first testing it while using a CDN. I discovered that Vue JS can still run smoothly with a CDN, but then I tested Vue JS locally, and preferred to view the Vue JS code locally. I discovered that when you make a Vue project locally, when you view the preview, it automatically updates on the page, so you don't need to reload like you'd do with `http-server` while using a CDN. Additionally, when you make a Vue JS project locally, you're able to code JS, HTML, and CSS in the same file, which is more convenient than using a CDN. Using a CDN also means you need to use more code, such as `.mount`, to apply your changes to the specific element.

Below shows the difference between the JS code you would need for a CDN and using Vue JS locally.
...
* **Embracing failure**
    * As mentioned earlier, I first tried to test out with React JS to solve my problem. However, React JS was harder to set up locally and kind of a headache, but I tried to persevere and decided to go to my backup tool, which was Vue JS. Vue JS worked way smoother for me, and I was able to locally use it in my IDE. I didn't give up on the task despite failure and found an alternative.
* **Consideration**
    * When I started my project, I already had a general idea that I wanted my project to be a math memorization game. However, this was the time when I was also considering what tool to use to solve my problem. I had to be considerate of how users would interact with my website, and make sure I chose the tool that would correctly represent my project. So, after asking for advice from [ChatGPT](https://chatgpt.com/), I decided Vue JS would be the best fit.
